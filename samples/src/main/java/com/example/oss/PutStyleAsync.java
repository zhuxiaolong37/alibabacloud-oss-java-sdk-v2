...
public class PutStyleAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient asyncClient = clientBuilder.build()) {
            ...
            CompletableFuture<PutStyleResult> future = asyncClient.putStyleAsync(request);
            PutStyleResult result = future.get();
