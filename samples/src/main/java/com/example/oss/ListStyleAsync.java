...
public class ListStyleAsync implements Example {
    ...
    private static void execute(
        ...
        try (OSSAsyncClient asyncClient = clientBuilder.build()) {
            ...
            CompletableFuture<ListStyleResult> future = asyncClient.listStyleAsync(request);
            ListStyleResult result = future.get();
