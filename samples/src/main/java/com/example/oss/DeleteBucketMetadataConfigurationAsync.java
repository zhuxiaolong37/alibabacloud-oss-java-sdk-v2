...
import com.aliyun.sdk.service.oss2.models.DeleteBucketMetadataConfigurationRequest;
import com.aliyun.sdk.service.oss2.models.DeleteBucketMetadataConfigurationResult;
import org.apache.commons.cli.CommandLine;
import org.apache.commons.cli.Option;
import org.apache.commons.cli.Options;
import org.apache.commons.cli.ParseException;

public class DeleteBucketMetadataConfigurationAsync implements Example {
    ...
    private static void execute(String endpoint, String region, String bucket) {
        ...
        try (OSSAsyncClient client = getDefaultAsyncClient(endpoint, region, provider)) {
            // Delete the bucket metadata table configuration.
            DeleteBucketMetadataConfigurationResult result = client.deleteBucketMetadataConfigurationAsync(
