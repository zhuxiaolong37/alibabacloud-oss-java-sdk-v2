...
public class GetStyleRequestTest {

    @Test
    public void testEmptyBuilder() {
        GetStyleRequest request = GetStyleRequest.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        // to builder
        GetStyleRequest copy = request.toBuilder().build();
    ...
    public void testToBuilderPreserveState() {
        GetStyleRequest original = GetStyleRequest.newBuilder()
                .bucket("test-bucket")
                .styleName("test-style")
                .build();

        GetStyleRequest copy = original.toBuilder().build();
