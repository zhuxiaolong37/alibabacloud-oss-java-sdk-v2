...
public class DeleteBucketMetadataConfigurationRequestTest {

    @Test
    public void testEmptyBuilder() {
        DeleteBucketMetadataConfigurationRequest request = DeleteBucketMetadataConfigurationRequest.newBuilder().build();
    ...
    public void testFullBuilder() {
        ...
        DeleteBucketMetadataConfigurationRequest request = DeleteBucketMetadataConfigurationRequest.newBuilder()
    ...
    public void testToBuilderPreserveState() {
        DeleteBucketMetadataConfigurationRequest original = DeleteBucketMetadataConfigurationRequest.newBuilder()
                .bucket("testbucket")
                .header("x-header-value", "value")
                .parameter("param", "value")
                .build();
        DeleteBucketMetadataConfigurationRequest copy = original.toBuilder().build();
